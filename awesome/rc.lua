...
-- {{{ awesome-switcher overrides
switcher.settings.preview_box = true
switcher.settings.preview_box_bg = "#222222aa"
switcher.settings.preview_box_border = "#22222200"
switcher.settings.preview_box_fps = 60
switcher.settings.preview_box_delay = 150
switcher.settings.preview_box_title_font = {"Tamsyn"}
...
switcher.settings.client_opacity_value = 0.75
...
--disabled as conflict with weechat buffer switching
...
--]]
	...
	{description = "toggle quake style " .. terminal, group = "client"}
    ),
    ...
    awful.key({ modkey }, "e", function () awful.spawn(gui_editor) end,
		{description="launch " .. gui_editor, group="launcher"}),
...
--    { rule = { class = "Pidgin" },
--      properties = { screen = 1, tag = screen[1].tags[7] }, floating = true},

    { rule = { class = "Gimp", role = "gimp-image-window" },
          properties = { screen = 1, tag = screen[1].tags[7], maximized = true } },

    { rule = { class = "Steam" },
  	  properties = { screen = 1, tag = screen[1].tags[4], floating = true} },
