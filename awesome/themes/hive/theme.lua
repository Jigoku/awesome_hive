...
--[[
     hive by Ricky Thomson
     github.com/jigoku
                  
     Based on powerarrow-dark by copycat-killer        
...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/hive"
theme.icon_theme								= "HighContrast"
theme.wallpaper                                 = theme.dir .. "/wall.jpg"
theme.font                                      = "GohuFont 9"
theme.fg_normal                                 = "#dfdfdd"
theme.fg_focus                                  = "#ffaa22"
theme.fg_urgent                                 = "#ff2222"
theme.bg_normal                                 = "#0b1317e8"
theme.bg_focus                                  = "#223344"
theme.bg_urgent                                 = "#1d1d1a"
...
--	awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons),nil,1400,nil
--    )

    s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons)

    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = theme.wibox_height, bg = theme.bg_normal, fg = theme.fg_normal })
    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, height = theme.wibox_height, bg = theme.bg_normal, fg = theme.fg_normal })
